				...
				<div class="ed-container-home <?php echo esc_attr($logo_align_class);?>">
					<div class="site-branding">
						...
						<nav id="site-navigation" class="main-navigation" role="navigation" style="position: relative">
							<!-- <div style="position: absolute;top: 0;left: 50px;width: 130px;"><img src="http://www.nhakhoasaomy.com/wp-content/uploads/2017/12/hoamai-nav.png" style="
...
"></div> -->
						...
						<div class="header-book-appointment">
							<a href="<?php echo get_home_url().'#dat-lich-hen'; ?>" class="header-btn-original">Đặt hẹn</a>
						</div>
					</div>
				</header><!-- #masthead -->
				<?php 
				$no_margin = "";
				//if(is_page_template( 'index.php' ) || is_page_template('template-boxedhome.php')){
