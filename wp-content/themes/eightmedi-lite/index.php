	...
	<main id="main" class="site-main" role="main">
		...
		if(get_theme_mod('eightmedi_lite_featured_setting_option','enable')=='enable'){
			...
			<section class="featured clear" id="featured-content">
				<div class="ed-container-home">
					...
					$i++;
					?>
					<div class="featured-block<?php if($i%3==0){echo " nomargin";} echo ' featured-post-'.$i;?> wow fadeInLeft"  data-wow-delay="<?php echo $i*0.3;?>s">
						<div class="featured-text">
							<figure class="featured-image">
								<?php if (has_post_thumbnail()):
								$image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),'thumbnail'); ?>
								<img style="height:77px" src="<?php echo esc_attr($image[0]); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" /><?php
								endif;
								?>
							</figure>
							<div class="featured-single-title"><?php the_title(); ?></div>
							<div class="featured-content"><?php echo get_the_content();?></div>
						</div>
					</div>
					<?php 
					endwhile;
		...
		<?php
			...
			if(get_theme_mod('eightmedi_lite_sponsers_setting_option')=='enable'){
				...
				<section class="our-sponsers clear">
					<div class="ed-container-home our-sponsers-section">
						...
						<div class="sponsers-wrap">
							...
							$i++;
							?>
							<div class="sponsers-block quotes-slider <?php if($i%4==0){echo " nomargin";} ?>  wow fadeInRight"  data-wow-delay="0.8s">
								<div class="sponsers-thumbnail">
								<?php if (has_post_thumbnail()):
								...
								<div class="sponsers-content">
									...
									<p style="text-align: right;"><small><em><?php echo the_title();?></em></small></p>
								</div>
							</div>
							<?php 
							endwhile;
		...
		if(get_theme_mod('eightmedi_lite_appointment_setting_option')=='enable'){
			...
			if(!empty($appointment_title)):
				?>
			<section class="appointment clear" id="dat-lich-hen">
				<div class="ed-container-home">
